...
export default function Experience() {
  const experiences = [
    ...
    {
      company: "TitansJet Systems",
      role: "Software Engineer",
      period: "2022 – 2023",
      desc: "Built and maintained scalable web applications with CodeIgniter, MySQL, and Node.js, implementing efficient APIs and DevOps pipelines.",
    },
  ];
    ...
    >
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
          My professional journey — from building scalable systems to crafting intuitive digital experiences.
        </p>
      </motion.div>
